...
- (IBAction) playInFullScreen: (id) sender {
	if (isFullscreen) {
		...
		GlkView __strong*tmpView = glkView;
		...
		GlkView __strong* tmpStrong = glkView;
		[tmpStrong removeFromSuperview];
		[[fullscreenWindow contentView] addSubview: tmpStrong];
		...
		tmpStrong = glkView;
		[tmpStrong removeFromSuperviewWithoutNeedingDisplay];
		...
		[[[self window] contentView] addSubview: tmpStrong];
